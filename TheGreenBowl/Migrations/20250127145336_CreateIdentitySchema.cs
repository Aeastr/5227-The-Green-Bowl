...
namespace TheGreenBowl.Migrations
{
    public partial class CreateIdentitySchema : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            //     constraints: table =>
            //     {
            //         table.PrimaryKey("PK_MenuCategory", x => new { x.menuID, x.categoryID });
            //         table.ForeignKey(
            ...
            //     constraints: table =>
            //     {
            //         table.PrimaryKey("PK_Menu_MenuItem", x => new { x.menuID, x.itemID });
            //         table.ForeignKey(
            //             name: "FK_Menu_MenuItem_Menu_menuID",
            //             column: x => x.menuID,
            //             principalTable: "Menu",
            //             principalColumn: "menuID",
            //             onDelete: ReferentialAction.Cascade);
            //         table.ForeignKey(
            //             name: "FK_Menu_MenuItem_MenuItem_itemID",
            //             column: x => x.itemID,
